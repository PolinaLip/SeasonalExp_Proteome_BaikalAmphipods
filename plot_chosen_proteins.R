...
ggplot(toplot, aes(time, intensities, group = time)) +
...
ggsave(file.path(current_dir, paste0('boxplots_Vg_withSexAssignment',
                                     '.png')),
       width = 9, height = 4.8, scale = 0.8)
...
#toplot <- subset(toplot, intensity < 3.5) 
